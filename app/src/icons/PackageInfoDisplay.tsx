...
export const PackageInfoDisplay = (props: SVGProps<SVGSVGElement> & {
    gradientFrom: string;
    gradientTo: string;
    text: string;
    textColor: string;
  ...
  >
    <g clip-path="url(#clip0_6_2)">
      ...
      <foreignObject x="40" y="30" width="420" height="300">
        <p className="font-mono text-[32px]" style={{color: `#${props.textColor}`}}>
            {props.text}
        </p>
    ...
    <defs>
      ...
      >
        <stop stop-color={`#${props.gradientFrom}`} />
        <stop offset="1" stop-color={`#${props.gradientTo}`} />
      </linearGradient>
